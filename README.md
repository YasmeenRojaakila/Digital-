< ! DOCTYPE html>
  < html lang ="en">
    ...
    <body>
      < div class =" rightbox"><!DOCTYPE html>
<html>
<head>
...
<body>
    ...
    <section about 
      i qm yasmeen roja i studing in bsc degree

    <section id="education">
        <div class="section-content">
            Bharathidasan unversity .bsc computer science
    </section>
                ...
                < body>
                  <h1>
                    ...
                    < h1>
                      ...
                      <p><div> Email : kalamkalam445544@gmail.com</div><div> phone : 6379146809
                        < hr>
                          < u1>
                            <b>
                              <li> Date of birth : 25/11/2003</li>
                              <li> Gender : Female</li>
                              <li> Marital status : No</li>
                              <li> Nationality : Indian</li>
                              <li> Language known : Tamil, English</li>
                            </ul>
